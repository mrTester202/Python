...
**11. Основы работы с PyQT6 (создание приложений под Desktop) (доп-но)**
    ...
    10.1 Что такое PyQT6? Основы PyQT6.
    🔹Л/Р №8 

**11.Заключительная часть курса основ программирования на Python**

    11.1 Разработка собственного проекта
    11.2 Путь к дальнейшему обучению
    11.3 Итоги
